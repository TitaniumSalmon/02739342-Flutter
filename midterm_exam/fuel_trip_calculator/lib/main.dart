...
class _ExampleStaggeredAnimationsState extends State<ExampleStaggeredAnimations>
  ...
  PreferredSizeWidget _buildAppBar() {
    return AppBar(
      title: const Text('โปรแกรมคำนวณค่าใช้จ่าย', style: TextStyle(color: Colors.white)),
    ...
    Column(
      ...
      children: [
        ...
        const Padding(
          ...
          child: Center(
            child: Text('โปรแกรมคำนวณค่าใช้จ่ายการเดินทางรถน้ำมันและรถไฟฟ้า (EV) เพื่อช่วยในการวางแผนการเดินทางของคุณ เพื่อให้คุณสามารถคำนวณค่าใช้จ่ายได้อย่างแม่นยำและสะดวกสบาย',
      ...
      child: Padding(
        ...
        child: AnimatedBuilder(
          ...
          child: ElevatedButton(
            ...
            child: const Text('ค่าใช้จ่ายการเดินทางรถน้ำมัน'),
          ),
        ),
      ),
    );
  }
  Widget _buildPage2Button() {
    return SizedBox(
      width: double.infinity,
      child: Padding(
        padding: const EdgeInsets.all(24),
        child: AnimatedBuilder(
          ...
          child: ElevatedButton(
            ...
            child: const Text('ค่าใช้จ่ายการเดินทางรถไฟฟ้า'),
          ),
        ),
      ),
    );
